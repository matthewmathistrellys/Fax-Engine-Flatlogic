  ...
  definition: {
    openapi: "3.0.0",
      info: {
        version: "1.0.0",
        title: "Fax Engine",
        description: "Fax Engine Online REST API for Testing and Prototyping application. You can perform all major operations with your entities - create, delete and etc.",
      },
    servers: [
      {
...
app.use('/api/faxes', passport.authenticate('jwt', {session: false}), faxesRoutes);
