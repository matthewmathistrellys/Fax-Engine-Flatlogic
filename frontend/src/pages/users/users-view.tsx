      ...
      <>
          ...
          <SectionMain>
            ...
            <CardBox>
                ...
                <>
                    <p className={'block font-bold mb-2'}>Faxes User</p>
                    <CardBox
                      className='mb-6 border border-gray-300 rounded overflow-hidden'
                      hasTable
                    >
                        <div className='overflow-x-auto'>
                            ...
                            <tbody>
                            {users.faxes_user && Array.isArray(users.faxes_user) &&
                              users.faxes_user.map((item: any) => (
                        ...
                        {!users?.faxes_user?.length && <div className={'text-center py-4'}>No data</div>}
                    </CardBox>
                </>
